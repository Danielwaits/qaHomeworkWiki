  ...
  */
  class fish extends Aniaml {
    ...
    constructor(name: string, food: string, saltwater:boolean) {
        ...
        //adding new params into the constructor to be able to use outside of the constuctor
    }
    soundofff(): string {
  ...
  */
  class Bird extends Animal {
    ...
    fly(): string {
        ...
        return `The ${this.name} flies at speeds of up to ${this.flightSpeed} meters per seconds!;
